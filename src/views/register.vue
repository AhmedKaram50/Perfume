<template>
  <div class="register">
    ...
    <div class="register-form">
      <div class="heading">
        <h4>Register</h4>
        <h5 @click="emailFromFooter()">
          Manage Your Smell And Make It like From Heaven Now
        </h5>
        <p>
      ...
      <form action="">
        ...
        <button
          type="submit"
          class="main-btn"
          @click.prevent="registerValidation"
        >
      ...
      createUserWithEmailAndPassword(auth, this.email, this.password)
        .then((result) => {
          ...
          const docRef = setDoc(doc(db, "users", result.user.uid), {
            ...
            agreed: this.agreed,
            profileImageUrl:
              "https://firebasestorage.googleapis.com/v0/b/perfume-b4165.appspot.com/o/avatar%2Fuser3.png?alt=media&token=4c8faa3d-aee4-41b6-b9c9-4892a7a48fa1",
          });

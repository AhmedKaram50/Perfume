<template>
  <div id="product" class="container" v-if="currentData">
    <div class="product">
      <SfGallery
        :images="[
          {
            mobile: { url: require(`../assets/${theProduct.productImage[0]}`) },
            desktop: { url: require(`../assets/${theProduct.productImage[0]}`) },
            big: { url: require(`../assets/${theProduct.productImage[0]}`) },
            alt: 'aaa',
          },
          {
            mobile: { url: require(`../assets/${theProduct.productImage[1] || theProduct.productImage[0] }`) },
            desktop: { url: require(`../assets/${theProduct.productImage[1] || theProduct.productImage[0] }`) },
            big: { url: require(`../assets/${theProduct.productImage[1] || theProduct.productImage[0] }`) },
            alt: 'aaa',
          },
          {
            mobile: { url: require(`../assets/${theProduct.productImage[2] || theProduct.productImage[0] }`) },
            desktop: { url: require(`../assets/${theProduct.productImage[2] || theProduct.productImage[0] }`) },
            big: { url: require(`../assets/${theProduct.productImage[2] || theProduct.productImage[0] }`) },
            alt: 'aaa',
          },
          /*{
            mobile: { url: require(`../assets/1_${theProduct.productImage}`)},
            desktop: { url: require(`../assets/1_${theProduct.productImage}`)},
            big: { url: require(`../assets/1_${theProduct.productImage}`)},
            alt: theProduct.productImage,
          },
          {
            mobile: { url: require(`../assets/2_${theProduct.productImage}`)},
            desktop: { url: require(`../assets/2_${theProduct.productImage}`)},
            big: { url: require(`../assets/2_${theProduct.productImage}`)},
            alt: theProduct.productImage,
          },
          {
            mobile: { url: require(`../assets/3_${theProduct.productImage}`)},
            desktop: { url: require(`../assets/3_${theProduct.productImage}`)},
            big: { url: require(`../assets/3_${theProduct.productImage}`)},
            alt: theProduct.productImage,
          },*/
        ]"
      ...
      <div class="product__info">
        ...
        <div class="product__price-and-rating">
          <SfPrice :regular="theProduct.price + currencySymbol" />
          <div>
        ...
        <div>
          ...
          <SfAddToCart
            ...
            @click="addProductToCart(theProduct)"
          />
        </div>
        <SfTabs
          id="tabs"
...
export default {
  ...
  created() {
    fetch(`https://rocky-oasis-81800.herokuapp.com/product/show?category=all`)
      ...
      .then((data) => {
        const current = data.products.filter(product => product.name == this.$route.params.name)[0]
